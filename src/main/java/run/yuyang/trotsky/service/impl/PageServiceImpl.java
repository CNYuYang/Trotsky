...
//            }
    ...
    public void updateCoverPage() {
        String template = vertx.fileSystem().readFileBlocking("template/_coverpage.md").toString();
        template = template.replace("{{description}}", indexService.getIndex().getDescription());
        StringBuilder builder = new StringBuilder();
        indexService.getIndex().getLinks().forEach(obj -> {
    ...
    public void updateIndexPage() {
        String template = vertx.fileSystem().readFileBlocking("template/index.html").toString();
        template = template.replace("{{title}}", indexService.getIndex().getTitle());
        StringBuilder builder = new StringBuilder();
        indexService.getIndex().getNavs().forEach(obj -> {
            //<a href="#/notes">笔记</a>
